...
#ifndef CXXBRIDGE1_ENUM_CostFn
#define CXXBRIDGE1_ENUM_CostFn
enum class CostFn : ::std::uint8_t {
  AstSize = 0,
  AstDepth = 1,
};
#endif // CXXBRIDGE1_ENUM_CostFn

#ifndef CXXBRIDGE1_ENUM_MimKind
#define CXXBRIDGE1_ENUM_MimKind
enum class MimKind : ::std::uint8_t {
  Let = 0,
  Lam = 1,
  Con = 2,
...
::rust::String pretty_slotted(::rust::Str sexpr, ::std::size_t line_len) noexcept {
  ::rust::MaybeUninit<::rust::String> return$;
  cxxbridge1$194$pretty_slotted(sexpr, line_len, &return$.value);
  return ::std::move(return$.value);
}
...
::std::size_t cxxbridge1$rust_vec$RuleSet$len(::rust::Vec<::RuleSet> const *ptr) noexcept;
::std::size_t cxxbridge1$rust_vec$RuleSet$capacity(::rust::Vec<::RuleSet> const *ptr) noexcept;
::RuleSet const *cxxbridge1$rust_vec$RuleSet$data(::rust::Vec<::RuleSet> const *ptr) noexcept;
void cxxbridge1$rust_vec$RuleSet$reserve_total(::rust::Vec<::RuleSet> *ptr, ::std::size_t new_cap) noexcept;
...
Vec<::RuleSet>::Vec() noexcept {
  cxxbridge1$rust_vec$RuleSet$new(this);
}
template <>
void Vec<::RuleSet>::drop() noexcept {
  return cxxbridge1$rust_vec$RuleSet$drop(this);
}
template <>
::std::size_t Vec<::RuleSet>::size() const noexcept {
  return cxxbridge1$rust_vec$RuleSet$len(this);
}
template <>
::std::size_t Vec<::RuleSet>::capacity() const noexcept {
  return cxxbridge1$rust_vec$RuleSet$capacity(this);
}
template <>
::RuleSet const *Vec<::RuleSet>::data() const noexcept {
  return cxxbridge1$rust_vec$RuleSet$data(this);
}
template <>
void Vec<::RuleSet>::reserve_total(::std::size_t new_cap) noexcept {
  return cxxbridge1$rust_vec$RuleSet$reserve_total(this, new_cap);
}
template <>
void Vec<::RuleSet>::set_len(::std::size_t len) noexcept {
  return cxxbridge1$rust_vec$RuleSet$set_len(this, len);
}
template <>
void Vec<::RuleSet>::truncate(::std::size_t len) {
